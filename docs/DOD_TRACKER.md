...
- [ ] Ingestion: post enters as URL or Markdown and is stored; generation reads only the stored post
- [ ] Constraint profiles enforced by code (length, tone, hashtag count); a test proves a bad variant is blocked
